...
console.log('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~');
console.log('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~');
console.log(`Logged in as  * [ "  Team #KingBot " ] servers! [ " ${client.guilds.size} " ] Users! [ " ${client.users.size} " ]`); 
...
if (message.content.startsWith('k#ownerbc')){
...
client.on('message', message => {
	...
	client.on('message', message => {
		if (message.content.startsWith("k#botinfo")) {
		...
		embed: new Discord.RichEmbed()
		   ...
		   .addField('``My ID``' , `[ ${client.user.id} ]` , true)
				 ...
				 .addField('``Bot Version``' , `[ Beta 0.1 ]` , true)
				 .setFooter('KiNGBoT TeAM')
		})
		}
		});
...
client.on('message', message => {
    ...
    .setDescription(`
    أمثله على الأوامر : 
    k#role @mention rolename : لأعطاء رتبة لعضو معين
    k#role all rolename : لأعطاء رتبة للجميع 
    k#role humans rolename : لأعطاء رتبة للاشخاص فقط
    k#role bots rolename : لأعطاء رتبة لجميع البوتات`)
    .setFooter('Requested by '+message.author.username, message.author.avatarURL)
  ...
  client.on('message', message => {
    ...
    .setDescription(`
    أمثله على الأوامر : 
    k#-role @mention rolename : لسحب رتبة لعضو معين
    k#-role all rolename : لسحب رتبة للجميع 
    k#-role humans rolename : لسحب رتبة للاشخاص فقط
    k#-role bots rolename : لسحب رتبة لجميع البوتات`)
    .setFooter('Requested by '+message.author.username, message.author.avatarURL)
  message.channel.sendEmbed(role)
    }})
    ...
    time: "3000",
     category : 'click here',
      channel : 'click here'
        ...
        if(message.content.startsWith('k#temp on')){
...
client.on("message", message => {
    if (message.content === "k#membercount") {
